                ...
                Column(
                    ...
                    Row(
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            Text("Closed", color = Color.White, fontSize = 11.sp, fontFamily = GameFont)
                        }
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            Image(
                            ...
                            Text("Safe", color = Color.White, fontSize = 11.sp, fontFamily = GameFont)
                        }
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            Image(
                            ...
                            Text("Danger!", color = Color(0xFFFF6B6B), fontSize = 11.sp, fontFamily = GameFont)
                        }
                    }
                }
            }
