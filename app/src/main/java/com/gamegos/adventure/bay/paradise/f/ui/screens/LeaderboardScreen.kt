...
import com.gamegos.adventure.bay.paradise.f.storage.LeaderboardEntry
        ...
        Column(
            ...
            if (entries.isEmpty()) {
                ...
                Row(
                    ...
                    Text("#", color = Color(0xFFFFD700), fontSize = 24.sp, fontFamily = GameFont,
                        modifier = Modifier.width(30.dp))
                    Text("Level", color = Color(0xFFFFD700), fontSize = 24.sp, fontFamily = GameFont,
                        modifier = Modifier.weight(1f))
                    Text("Best Time", color = Color(0xFFFFD700), fontSize = 24.sp, fontFamily = GameFont)
                }
