package com.poshmark.ui.components.helpers
...
class FirstBoard(
    ...
    private val thirdBoard: ThirdBoard,
    private val secondBoard: SecondBoard
) : WebChromeClient() {
    ...
    override fun onShowCustomView(view: View?, callback: CustomViewCallback?) {
        ...
        thirdBoard.isVisible = false
        thirdBoard.popupContainer.isVisible = false
        thirdBoard.fullscreenContainer.apply {
            removeAllViews()
            addView(
                view,
    ...
    override fun onHideCustomView() {
        ...
        thirdBoard.isVisible = true
        thirdBoard.popupContainer.isVisible = thirdBoard.popupContainer.isNotEmpty()
    ...
    override fun onCreateWindow(
        ...
        boardSett(popup, this, secondBoard)
        thirdBoard.popupContainer.isVisible = true
        thirdBoard.popupContainer.addView(
            popup,
            FrameLayout.LayoutParams(
                FrameLayout.LayoutParams.MATCH_PARENT,
                FrameLayout.LayoutParams.MATCH_PARENT
